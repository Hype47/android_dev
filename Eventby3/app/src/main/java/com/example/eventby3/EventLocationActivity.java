...
public class EventLocationActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Card init
        TextView textTitle = findViewById(R.id.textEventTitle2);
        textTitle.setText(title);
        TextView textDate = findViewById(R.id.textEventDate2);
        textDate.setText(period);
        ...
        mapView = findViewById(R.id.mapViewEvent2);
