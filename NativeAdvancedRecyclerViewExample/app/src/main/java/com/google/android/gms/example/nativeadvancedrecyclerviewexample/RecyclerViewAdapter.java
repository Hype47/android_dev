...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, List<Object> recyclerViewItems) {
        ...
        Log.e("recylerItem",recyclerViewItems.toString());
    }
    ...
    public int getItemViewType(int position) {
        ...
        Log.e("Object",recyclerViewItem.toString());
        if (recyclerViewItem instanceof UnifiedNativeAd) {
            Log.e("Result",Integer.toString(UNIFIED_NATIVE_AD_VIEW_TYPE));
            return UNIFIED_NATIVE_AD_VIEW_TYPE;
        }
        Log.e("Result",Integer.toString(MENU_ITEM_VIEW_TYPE));
...
public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    switch (viewType) {
        case UNIFIED_NATIVE_AD_VIEW_TYPE:
            ...
            Log.e("NativeAd",nativeAd.toString());
            break;
        case MENU_ITEM_VIEW_TYPE:
            // fall through
        default:
